...
Future<Stream<Market>> getNearMarkets(LocationData myLocation, LocationData areaLocation) async {
  ...
  final String url = '${GlobalConfiguration().getValue('api_base_url')}markets?$_nearParams&$_orderLimitParam';
...
Future<Stream<Market>> searchMarkets(String search, LocationData location) async {
  ...
  final String url = '${GlobalConfiguration().getValue('api_base_url')}markets?&$_searchParam&$_locationParam&$_orderLimitParam';
...
Future<Stream<Market>> getMarket(String id) async {
  final String url = '${GlobalConfiguration().getValue('api_base_url')}markets/$id';
